...
Hodstack is before its first tag. Every push to `0.x` builds the binary again, and each command above gives you that build. Run `hod --version` to see the commit you have.
